...
baseDir = "data/structured/nff/minute/"
...
filePath = r"data/unstructured/Backtest Data-20190102T054135Z-001/Backtest Data/NF One Minute Data - 2008 - 2018"
...
for dateData in groupData:
    ...
    with open('data/structured/nff/minute/' + date + '.json', 'w') as outfile:

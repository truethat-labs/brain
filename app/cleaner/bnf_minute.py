...
baseDir = "data/structured/bnf/minute/"
...
filePath = r"data/unstructured/Backtest Data-20190102T054135Z-001/Backtest Data/BNF - One Minute data - 2009-2018"
...
for dateData in groupData:
    ...
    with open('data/structured/bnf/minute/' + date + '.json', 'w') as outfile:

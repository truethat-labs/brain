...
with open('tests/data/breakouts.json') as f:
    breakouts = json.load(f)

with open('tests/data/minutes_single/buy_breakout_target.json') as f:
    minutes = json.load(f)

response = result.get(minutes, breakouts)
...
with open('tests/data/minutes_single/buy_breakout_sl.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/buy_breakout_eod_profit.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/buy_breakout_eod_loss.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/buy_breakout_eod_ctc.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/sell_breakout_target.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/sell_breakout_sl.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/sell_breakout_eod_profit.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/sell_breakout_eod_loss.json') as f:
    minutes = json.load(f)
...
with open('tests/data/minutes_single/sell_breakout_eod_ctc.json') as f:
    minutes = json.load(f)
